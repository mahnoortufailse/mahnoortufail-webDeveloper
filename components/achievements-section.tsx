...
const achievements = [
  {
    icon: Trophy,
    title: "Top Performer",
    description: "Recognized as top performer during internship at hiSkyTech",
    date: "2024",
  ...
  
  {
    ...
    description: "Optimized API calls reducing load times by 30%",
    date: "2024",
    category: "Technical",
