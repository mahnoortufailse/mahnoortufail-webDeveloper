        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Get to know more about my journey, education, and passion for software development
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="space-y-4">
                <h3 className="text-2xl font-heading font-semibold text-foreground">Hello, I'm Mahnoor!</h3>
                {/* ... existing content ... */}
              </div>
            </div>
            <div className="space-y-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-start">
          ...
          >
            <StaggerWrapper className="space-y-4">
              ...
              <motion.p className="text-sm sm:text-base text-muted-foreground leading-relaxed" variants={staggerItem}>
                I am a passionate BS Software Engineering student at COMSATS University Islamabad (Abbottabad) with a
                strong foundation in full-stack web development. My journey in software development has been driven by
                curiosity and a desire to create innovative solutions that make a real impact.
              </motion.p>
              <motion.p className="text-sm sm:text-base text-muted-foreground leading-relaxed" variants={staggerItem}>
                Skilled in React JS, Node.js, MongoDB, Next JS, and Express, I specialize in creating dynamic web
                applications with a focus on efficiency and innovation. I thrive in collaborative environments and am
                dedicated to continuous growth in software development.
              </motion.p>
              <motion.p className="text-sm sm:text-base text-muted-foreground leading-relaxed" variants={staggerItem}>
                Fluent in both English and Urdu, I bring strong communication skills to every project. My experience
                spans from building drag-and-drop form builders like SignaForm to contributing to enterprise
                applications like Sinapsity.
              </motion.p>
            </StaggerWrapper>

            <StaggerWrapper className="grid grid-cols-2 gap-3 sm:gap-4 pt-6">
              {[
                { value: 3.52, label: "Current CGPA" },
                { value: 2026, label: "Expected Graduation" },
                { text: "MERN", label: "Stack Specialist" },
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-muted-foreground font-medium">Computer Science</p>
                          <p className="text-sm text-muted-foreground">Army Public School (APSACS)</p>
