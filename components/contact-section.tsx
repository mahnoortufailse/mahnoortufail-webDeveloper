                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+923301546778" className="text-muted-foreground hover:text-accent transition-colors">
                        +92 330 1546778
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Abbottabad, Pakistan</p>
                    </div>
                  </div>
