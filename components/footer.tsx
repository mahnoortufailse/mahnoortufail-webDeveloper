...
import { Github, Linkedin, Mail, Heart, ChevronUp, Code, Zap, Globe, Star, ArrowRight } from "lucide-react"
        ...
        <div ref={footerRef} className="reveal">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12 mb-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="flex items-center gap-4">
                <div className="relative">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-primary flex items-center justify-center shadow-theme-medium hover-lift">
                    <span className="text-white font-heading font-bold text-xl">MT</span>
                  </div>
                  <div className="absolute -top-1 -right-1 w-4 h-4 bg-chart-1 rounded-full animate-pulse"></div>
                </div>
                <div>
                  <h3 className="font-heading font-bold text-2xl text-foreground theme-transition">Mahnoor Tufail</h3>
                  <p className="text-muted-foreground font-medium theme-transition">Full-Stack Developer & Innovator</p>
                </div>
              </div>

              <p className="text-muted-foreground leading-relaxed max-w-md theme-transition">
                Passionate software engineering student specializing in MERN stack development. Creating innovative web
                solutions with modern technologies and best practices. Always learning, always building.
              </p>

              {/* Tech Stack Badges */}
              <div className="flex flex-wrap gap-2">
                {["React", "Node.js", "MongoDB", "Next.js", "TypeScript"].map((tech, index) => (
                  <Badge
                    key={tech}
                    variant="outline"
                    className={`px-3 py-1 text-xs glass-card hover:bg-gradient-primary hover:text-white transition-all duration-300 hover-lift animate-fade-in-up animate-stagger-${index + 1} theme-transition`}
                  >
                    {tech}
                  </Badge>
                ))}
              ...
              <div className="flex gap-3">
                <a
                  href="https://github.com/mahnoortufailse"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/mahnoortufail/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group p-3 rounded-xl glass-card hover:bg-gradient-primary hover:text-white transition-all duration-300 shadow-theme-light hover-lift border border-border/50 theme-transition"
                >
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={link.name}>
                    <a
                      href={link.href}
                      className={`group flex items-center gap-2 text-muted-foreground hover:text-accent transition-all duration-300 animate-fade-in-left animate-stagger-${index + 1} theme-transition hover-glass px-2 py-1 rounded-lg`}
                    >
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li
                    key={service}
                    className={`flex items-center gap-2 text-muted-foreground animate-fade-in-right animate-stagger-${index + 1} theme-transition`}
                  >
              ...
              <div className="p-4 rounded-xl glass-card border border-chart-1/20 theme-transition">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-foreground theme-transition">Available for Projects</span>
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 py-8 border-y border-border/50">
            <div className="text-center group glass-card p-4 rounded-xl hover-lift theme-transition">
              ...
              <div className="text-xs text-muted-foreground theme-transition">Current CGPA</div>
            </div>
            <div className="text-center group glass-card p-4 rounded-xl hover-lift theme-transition">
              <div className="text-2xl font-heading font-bold text-accent group-hover:scale-110 transition-transform">
                3+
              </div>
              <div className="text-xs text-muted-foreground theme-transition">Companies</div>
            </div>
            <div className="text-center group glass-card p-4 rounded-xl hover-lift theme-transition">
              <div className="text-2xl font-heading font-bold text-accent group-hover:scale-110 transition-transform">
                5+
            ...
            <div className="text-center group glass-card p-4 rounded-xl hover-lift theme-transition">
              ...
              <div className="text-xs text-muted-foreground theme-transition">Technologies</div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 py-8">
            <div className="flex flex-col md:flex-row items-center gap-4 text-sm text-muted-foreground theme-transition">
              <span>© {currentYear} Mahnoor Tufail. All rights reserved.</span>
