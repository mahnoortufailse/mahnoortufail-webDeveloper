...
export function EnhancedContactSection({ onDownloadResume }: { onDownloadResume: () => void }) {
  ...
  return (
    <SectionWrapper id="contact" className="py-12 sm:py-16 lg:py-20 bg-muted/30 relative overflow-hidden">
      {/* Background Pattern */}
      <motion.div
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                      <motion.div variants={hoverScale} whileHover="hover" whileTap="tap" className="flex-1">
                        <Button variant="outline" size="lg" className="w-full glass hover-glow bg-transparent" asChild>
                          <a
                      ...
                      >
                        ...
                        >
                          <Input
                            ...
                            className={`glass transition-all duration-300 border border-border/50 ${errors.name ? "border-red-500 animate-shake" : ""} ${focusedField === "name" ? "ring-2 ring-accent/50" : ""}`}
                          />
                        </motion.div>
                        <AnimatePresence>
                          {errors.name && (
                      ...
                      >
                        ...
                        >
                          <Input
                            ...
                            onBlur={() => setFocusedField(null)}
                            className={`glass transition-all duration-300 border border-border/50 ${errors.email ? "border-red-500 animate-shake" : ""} ${focusedField === "email" ? "ring-2 ring-accent/50" : ""}`}
                          />
                        </motion.div>
                        <AnimatePresence>
                          {errors.email && (
                    ...
                    >
                      ...
                      >
                        <Input
                          ...
                          onBlur={() => setFocusedField(null)}
                          className={`glass transition-all duration-300 border border-border/50 ${errors.subject ? "border-red-500 animate-shake" : ""} ${focusedField === "subject" ? "ring-2 ring-accent/50" : ""}`}
                        />
                      </motion.div>
                      <AnimatePresence>
                        {errors.subject && (
                          ...
                          >
                            ...
                            <span className="break-words">{errors.subject}</span>
                          </motion.p>
                        )}
                      </AnimatePresence>
                    </motion.div>
                    ...
                    >
                      ...
                      >
                        <Textarea
                          ...
                          onBlur={() => setFocusedField(null)}
                          className={`glass resize-none transition-all duration-300 border border-border/50 ${errors.message ? "border-red-500 animate-shake" : ""} ${focusedField === "message" ? "ring-2 ring-accent/50" : ""}`}
                        />
                      </motion.div>
                      <AnimatePresence>
                        {errors.message && (
