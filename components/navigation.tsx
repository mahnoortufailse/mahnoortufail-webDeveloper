        ...
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          <div className="flex items-center gap-2 sm:gap-3 group">
            ...
            <div className="font-heading font-bold text-lg sm:text-xl text-foreground group-hover:text-gradient-primary transition-all duration-300">
              <span className="hidden xs:inline">Mahnoor Tufail</span>
            ...
            <div className="px-4 pt-3 pb-4 sm:pt-4 sm:pb-6 space-y-1 sm:space-y-2">
              {[
                ...
                <a
                  ...
                  href={item.href}
                  onClick={(e) => handleNavClick(e, item.href)}
                  className={`block px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base text-muted-foreground hover:text-accent hover-glass transition-all duration-300 rounded-xl animate-fade-in-down animate-stagger-${index + 1} theme-transition`}
                >
                  {item.name}
                </a>
              ))}
